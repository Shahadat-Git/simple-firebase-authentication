    ...
    return (
        <div>
            ...
            <form onSubmit={handleResigter} className='border rounded w-1/2 mx-auto text-center'>
                <input type="text" id='name' name='name' placeholder="Your Name" className="input input-bordered input-info w-full max-w-xs m-3" required />
                <br />
                <input type="email" name='email' id='email' placeholder="Your Email" className="input input-bordered input-info w-full max-w-xs m-3" required />
                <br />
                <input type="password" name='password' id='password' placeholder="Your Password" className="input input-bordered input-info w-full max-w-xs m-3" required />
                <br />
